...
function buildTable(filterData) {
    var data = filterData
    var table = d3.select("#cities-table");
    // remove elements
    ...
    for (var i = 0; i < len; i++) {
		...
		trow.append("td").text(data[i].City_ID);
		 trow.append("td").text(data[i].City);
        trow.append("td").text(data[i].Country);
		trow.append("td").text(data[i].Date);
        trow.append("td").text(data[i].MaxTemp);
		trow.append("td").text(data[i].Humidity);
		trow.append("td").text(data[i].Cloudiness);
		trow.append("td").text(data[i].WindSpeed);
    }
}
